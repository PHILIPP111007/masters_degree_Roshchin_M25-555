...
### 4.4. Связь с распределением простых чисел

В ходе визуального анализа слоистой структуры было установлено, что **простые числа и составные числа распределены по дугам (слоям \(z\)) совместно**. Они не разделены на отдельные «чистые» слои, а находятся **вперемешку** на одних и тех же изогнутых линиях.

Однако было обнаружено **фундаментальное геометрическое различие**: простые числа **никогда не опускаются ниже естественного порога**:

$$
R(n) = \frac{m(n)}{n} \ge 0.40
$$

В то время как составные числа могут свободно пересекать этот порог и находиться как выше, так и ниже него.

**Ключевой вывод:** Простые числа не занимают изолированную область пространства, но они **строго ограничены снизу**. Порог \(0.40\) является **естественной нижней границей**, ниже которой простые числа не встречаются. Это означает, что в слоистой структуре целых чисел существует **чёткая геометрическая граница**, разделяющая простые и составные числа.

Таким образом, слои \(z\) представляют собой не только аналитический инструмент, но и **реальную геометрическую структуру числового пространства**, в которой простые числа всегда занимают верхнюю часть каждого слоя, **не пересекая порог 0.40**.

![Описание гифки](crystal_growth.gif)
